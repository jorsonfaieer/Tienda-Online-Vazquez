...
const ropa = [
    new Producto("Buzo", "Buzo Kongo Slime Pink", 26990, 1000, false, "/src/img/Buzo Kongo Slime Pink.webp"),
    new Producto("Buzo", "Buzo Kongo Slime Sky Blue", 26990, 1001, true, "/src/img/BuzoKongoSlimeSkyBlue.webp"),
    new Producto("Buzo", "Buzo Kongo Tour", 25990, 1002, true, "/src/img/Buzo Kongo Tour.webp"),
    new Producto("Buzo", "Buzo Summer Lime", 23990, 1009, false, "/src/img/Buzo Summer Lime.webp"),
    new Producto("Remera", "Remeron Kongo Blanco", 11990, 1010, true, "/src/img/Remeron Kongo Blanco.webp"),
    new Producto("Remera", "Remeron Kongo Negro", 11990, 1011, false, "/src/img/Remeron Kongo Negro.webp"),
    new Producto("Pantalon", "Pantalon Parachute Pink", 19990, 1016, false, "/src/img/Pantalon Parachute Pink.webp"),
    new Producto("Pantalon", "Pantalon Cargo Black", 24590, 1017, true, "/src/img/Pantalon Cargo Black.webp"),
];
    ...
    eliminarProducto.forEach(btn => {
        btn.addEventListener('click', ()=>{
            ...
            for (let i = 0; i < carrito.length; i++) {
                if(carrito[i][0] === btn.parentElement.querySelector('p').textContent){
                    posicion = i;
                }
            }

            total -= parseFloat(btn.parentElement.querySelector('span').textContent.slice(1));
...
const mostrarProductos = ()=>{
    ...
    btnAgregarAlCarrito.forEach(btn => {
        btn.addEventListener('click', ()=>{
            ...
            let precioProd = parseFloat(btn.parentElement.querySelector('span').textContent.slice(1));
